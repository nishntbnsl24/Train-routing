...
public class Customer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton2.setText("Sleeper");

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("General");

        buttonGroup1.add(jRadioButton4);
        jRadioButton4.setText("Tatkal");
        ...
        for (int vertexIndex = 0;
            ...
            if (vertexIndex != startVertex && vertexIndex == dest) {
                ...
                if (distances[vertexIndex] != 100000) {
                    ...
                    jRadioButton1.setActionCommand("50");
                    jRadioButton2.setActionCommand("40");
                    jRadioButton3.setActionCommand("30");
                    jRadioButton4.setActionCommand("20");
                    double cost=Double.parseDouble(buttonGroup1.getSelection().getActionCommand());                        
                    double ticketcost = distances[vertexIndex] * cost;
                    jLabel4.setText("Ticket Price: " + ticketcost);
